...
//import net.fnothaft.gnocchi.primitives.association.{ AdditiveLogisticAssociation, DominantLogisticAssociation }
...
//
//trait LogisticSiteRegression[VM <: VariantModel[VM], A <: Association[VM]] extends SiteRegression[VM, A] {
//
//  /**
