...
class LinearVariantModelSuite extends GnocchiFunSuite {
  ...
  ignore("Test constructUpdatedVariantModel works") {
  ...
  ignore("Test constructUpdatedVariantModel with association parameter works") {
    //      val assoc = LinearAssociation(ssDeviations = 0.5,
    //        ssResiduals = 0.5,
    //        geneticParameterStandardError = 0.5,
    //        tStatistic = 0.5,
  ...
  ignore("Test LinearVariantModel.mergeWith works") {
